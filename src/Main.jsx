  ...
  return (
    <div className='h-[90%] w-full flex items-center justify-center'>
        <div className='h-full w-3/4 '>
            ...
            <div className='h-[87%] w-full flex flex-wrap items-center justify-start py-10 '>
                {
                    data.map((item) => {
                        const {id, url, image,title} = item
                        return(
                            <div className='group relative  h-[150px] w-[300px] ml-12 mt-5 overflow-hidden  transition-all duration-300 ease-in rounded border-2 border-blue-100' key={id}>
                                <a href={url}>
